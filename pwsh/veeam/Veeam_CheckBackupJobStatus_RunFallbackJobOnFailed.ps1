...
function Show-Help {
    ...
    Write-Host "  .\Veeam-FailedJob-Failover.ps1 <QueryJob> <FailoverJob> [options]"
    Write-Host ""
    ...
    Write-Host "  .\Veeam-FailedJob-Failover.ps1 'PROD_SQL_Backup' 'PROD_SQL_Backup_Failover'" -ForegroundColor Green
    Write-Host ""
    Write-Host "  # Dry run - shows all steps but does NOT start any jobs"
    Write-Host "  .\Veeam-FailedJob-Failover.ps1 'PROD_SQL_Backup' 'PROD_SQL_Backup_Failover' -DryRun" -ForegroundColor Green
    Write-Host ""
    Write-Host "  # Verbose - shows detailed output and DOES start failover job if needed"
    Write-Host "  .\Veeam-FailedJob-Failover.ps1 'PROD_SQL_Backup' 'PROD_SQL_Backup_Failover' -Verbose" -ForegroundColor Green
    Write-Host ""
    Write-Host "  # Dry run + Verbose - maximum detail, does NOT start any jobs"
    Write-Host "  .\Veeam-FailedJob-Failover.ps1 'PROD_SQL_Backup' 'PROD_SQL_Backup_Failover' -DryRun -Verbose" -ForegroundColor Green
    Write-Host ""
    Write-Host "  # Show this help message"
    Write-Host "  .\Veeam-FailedJob-Failover.ps1 -Help" -ForegroundColor Green
    Write-Host ""
    Write-Host "========================================================" -ForegroundColor Cyan
    Write-Host ""
}
